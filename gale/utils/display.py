# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/00a_utils.display.ipynb (unless otherwise specified).

__all__ = ['subplots', 'show_image', 'show_titled_image', 'show_images', 'imshow_tensors', 'show_title']
