# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/00b_utils.structures.ipynb (unless otherwise specified).

__all__ = ['ACTIVATION_REGISTRY', 'IMAGE_CLASSIFIER_BACKBONES', 'IMAGE_CLASSIFIER_HEADS', 'META_ARCH_REGISTRY',
           'OPTIM_REGISTRY', 'SCHEDULER_REGISTRY', 'LOSS_REGISTRY', 'DatasetCatalog']
