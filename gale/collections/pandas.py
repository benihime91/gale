# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/05_collections.pandas.ipynb (unless otherwise specified).

__all__ = ['logger', 'folder2df', 'split_dataframe_into_stratified_folds', 'get_dataframe_fold', 'get_dataset_labeling',
...
def split_dataframe_into_stratified_folds(
    dataframe: pd.DataFrame, label_column: str, fold_column: str = None, **kwargs
):
    """
...
def dataframe_labels_2_int(
    dataframe: pd.DataFrame, label_column: str, return_labelling: bool = False
):
    """
