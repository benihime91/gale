# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/06b_collections.callbacks.ema.ipynb (unless otherwise specified).

__all__ = ['log', 'EMACallback']
...
class EMACallback(Callback):
    ...
    def on_train_end(self, trainer, pl_module):
        ...
        if self.use_ema_weights:
            self.copy_to(self.ema.module.parameters(), pl_module.parameters())
            log("Model weights replaced with the EMA version.")
