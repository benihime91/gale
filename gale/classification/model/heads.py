# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/04a_classification.models.heads.ipynb (unless otherwise specified).

__all__ = ['IMAGE_CLASSIFIER_HEADS', 'ImageClassificationHead', 'FullyConnectedHead', 'FCHeadDataClass', 'FastaiHead',
           'FastaiHeadDataClass']
...
from ...utils.structures import IMAGE_CLASSIFIER_HEADS
